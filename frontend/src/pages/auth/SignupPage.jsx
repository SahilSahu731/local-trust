            ...
            <div className="w-full max-w-xl shadow-lg rounded-xl shadow-gray-400 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <input type="text" name="firstName" placeholder="First Name" onChange={handleChange} className="w-full p-3 bg-gray-50 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500" required />
                        <input type="text" name="lastName" placeholder="Last Name" onChange={handleChange} className="w-full p-3 bg-gray-50 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500" required />
                    </div>
                    ...
                    <div className="space-y-2">
                         ...
                         <div className="flex gap-4">
                            <label className="flex items-center p-3 w-1/2 bg-gray-50 border border-gray-300 rounded-md cursor-pointer hover:bg-gray-100 has-[:checked]:bg-teal-50 has-[:checked]:border-teal-500">
                                <input type="radio" name="role" value="customer" checked={formData.role === 'customer'} onChange={handleChange} className="mr-2 accent-teal-600" />
                                Customer
                            </label>
                            <label className="flex items-center p-3 w-1/2 bg-gray-50 border border-gray-300 rounded-md cursor-pointer hover:bg-gray-100 has-[:checked]:bg-teal-50 has-[:checked]:border-teal-500">
                                <input type="radio" name="role" value="service_provider" checked={formData.role === 'service_provider'} onChange={handleChange} className="mr-2 accent-teal-600" />
                                Service Provider
                            </label>
                         </div>
                    </div>
